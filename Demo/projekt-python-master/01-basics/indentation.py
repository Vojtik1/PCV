...
def funkce(num):
    """
    Tato funkce generuje náhodné číslo a porovná ho s čísly v seznamu.
    """
    vygenerovane_cislo = random.randrange(1, 10)
    print("Vygenerované číslo:", vygenerovane_cislo)

    for cislo in num:
        if vygenerovane_cislo == cislo:
            print(f"Číslo {vygenerovane_cislo} je v seznamu.")
            return

    print(f"Číslo {vygenerovane_cislo} není v seznamu.")
